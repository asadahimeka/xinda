<template>
  <div class="sett">
    <div class="sett1">
      <a href="javascript:void(0)" class="settin1 m" @click="zhszhxgmm1">账户设置</a>
      <a href="javascript:void(0)" class="settin2" @click="zhszhxgmm2">修改密码</a>
    </div>
    <div class="setti">
      <!--账户设置部分-->
      <div class="sett2">
      ...
      <div class="sett3">
        <span>姓名：</span><input class="input" type="text" name="" placeholder="请输入姓名" v-model="newname"></div>
      <div class="sett4">
        <span>性别：</span>
        <input type="radio" name="sex" @click="sex=1" checked>男
        <input type="radio" style="margin-left:20px" name="sex" @click="sex=0">女
      </div>
      <div class="sett3">
        <span>邮箱：</span><input class="input" type="text" placeholder="请输入邮箱地址" v-model="email">
      </div>
      <div class="sett5">
        <span>所在地区：</span>
