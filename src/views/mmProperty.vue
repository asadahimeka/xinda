    ...
    <div class="property container">
        ...
        <div class="propertyFooter">
            <div>
                ...
                <h2>资质认证<br><span>服务商100%实名认证</span></h2>
            </div>
            <div>
                <img src="../assets/icon_pay.png" alt="">
                <h2>支付安全<br><span>明码标价支付</span></h2>
            </div>
            <div>
                <img src="../assets/icon_compensation.png" alt="">
                <h2>保险赔付<br><span>出现问题保险赔付</span></h2>
            </div>
            <div>
                <img src="../assets/icon_aftersale.png" alt="">
                <h2>售后无忧<br><span>客服经理全程跟进</span></h2>
            </div>
        </div>
    </div>
</template>
