...
export default {
    ...
    methods: {
        ...
        getProducts() {
            this.$ajax.post(this.$baseUrl+'/xinda-api/product/package/search-grid', this.productData, {}).then((data) => {
        ...
        getProviders() {
            this.$ajax.post(this.$baseUrl+'/xinda-api/provider/search-grid', this.providerData, {}).then((data) => {
